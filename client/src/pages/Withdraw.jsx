...
const Withdraw = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const token = localStorage.getItem('token');
      await axios.post('http://localhost:5000/api/accounts/withdraw', formData, {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  return (
    <div className="max-w-xl mx-auto">
      <h1 className="text-3xl font-bold text-white mb-8">Withdraw Money</h1>
      ...
      <div className="card">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button 
            type="submit" 
            className="btn-primary w-full mt-4 py-3 text-lg bg-orange-600 hover:bg-orange-700 focus:ring-orange-500"
